...
public class MediaModel {
  ...
  public static ArrayList<MediaItem> allMediaItemsInOne;
  ...
  private static void loadAllMediaItem(Activity activity){
    ...
    sortAllMediaItem(1);
    loadAllMediaItemInOne();
  }

  private static void loadAllMediaItemInOne(){
    allMediaItemsInOne = new ArrayList<>();
    for(ArrayList<MediaItem> arrL : allMediaItems){
      for(MediaItem item : arrL){
        allMediaItemsInOne.add(item);
      }
    }
  }
