...
public class SlideShowInAlbumActivity extends AppCompatActivity {
  private Intent intent;
  private int position;
  private int position1;
  private ArrayList<com.example.albumanh.MediaItem> listMedia;
  String returnUri;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    listMedia = ListMediaActivity.listMedia;
